...
const QuestSideNav = ({ nav, setNav }) => {
    ...
    const clickNav = (clickedNav) => {
        ...
        document.querySelector(`.${clickedNav}`).classList.add("active");
    };
    ...
    const defaultContent = () => {
        return (
            <>
                <li>
                    <div className="home" onClick={() => clickNav("home")}>
                        Home
                    </div>
                </li>
                <li>
                    ...
                    return (
                        <>
                            ...
                            <li>
                                <div
                                    className="vote-mwa"
                                    onClick={() => history.push("/vote-mwawm")}
                                >
                                    Pemilihan MWAWM
                                </div>
                            </li>
                ...
                case 5:
                    return (
                        <>
                            ...
                            <li>
                                <div
                                    className="tim-sukses"
                                    onClick={() => clickNav("tim-sukses")}
                                >
                                    Tim Sukses
                                </div>
                            </li>
                            ...
                            <li>
                                <div
                                    className="hasil-pemira"
                                    onClick={() => clickNav("hasil-pemira")}
                                >
                                    Hasil Pemira
                                </div>
                            </li>
